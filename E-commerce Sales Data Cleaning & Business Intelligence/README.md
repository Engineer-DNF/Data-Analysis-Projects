...
The dashboard includes interactive filters that allow users to explore sales performance by product, marketing channel, and region.
...
- Gaming Monitor, Nintendo Switch, and PlayStation 5 were the top revenue-generating products.
...
│   ├── Overall-Revenue.png
│   ├── Product-Revenue.png
│   ├── marketing-revenue.png
│   └── regional-revenue.png
│
└── README.md
```
